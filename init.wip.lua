...
vim.keymap.set('n', '<leader>x', function() require("luasnip.loaders").edit_snippet_files(nil) end)
vim.keymap.set('n', '<leader>y', ':let @+ = expand("%")<cr>')
vim.keymap.set('n', '<leader>z',
  function() if vim.wo.foldlevel > 0 then vim.wo.foldlevel = 0 else vim.wo.foldlevel = 99 end end)
...
require('packer').startup(function()
  ...
  use {"williamboman/mason-lspconfig.nvim", config = function () require("mason-lspconfig") end}
